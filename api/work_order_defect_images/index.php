...
$config = [
    'table' => 'work_order_defect_images',
    'label' => '工單不良品圖片',
    'upload_dir' => 'uploads/work_order_defect_images',
    'file_prefix' => 'wo_defect',
    'audit_table' => 'work_order_defect_images',
    'success_message' => '不良品圖片上傳成功。',
    'audit_action' => 'Uploaded defect work order image',
    'operation_log_action_key' => 'upload_defect_image',
    'operation_log_action_label' => '上傳不良品圖片',
];

if ($method === 'GET') {
    handleListDefectImages($pdo, $config);
    return;
}

handleUploadDefectImage($pdo, $config);

function handleListDefectImages(PDO $pdo, array $config): void
{
...
function handleUploadDefectImage(PDO $pdo, array $config): void
{
    ...
    try {
        ...
        error_log('Upload defect image failed: ' . $e->getMessage());
