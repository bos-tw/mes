...
const commands = [
    ...
    ['node', ['tools/audit/tests/work-order-main-tabs.test.js']],
    ['node', ['tools/audit/tests/work-order-production-flow-contract.test.js']],
    ...
    ['node', ['tools/audit/tests/order-item-delivery-contract.test.js']],
