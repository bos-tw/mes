...
- [x] 工單詳情/編輯 API 回傳第二次篩選執行工單。
- [x] 工單詳情/編輯 API 回傳二次篩選結果摘要。
- [x] 工單端提供二次篩選詳情導頁。
- [x] 原始工單與二次篩選執行工單互相導頁。
- [ ] 工單編輯 modal 內新增可視化二次篩選摘要區。
...
- [ ] 側邊欄名稱從「二次重篩歷史紀錄」調整為「二次篩選紀錄」。
- [x] 模組標題與按鈕文案統一使用「二次篩選」。
- [ ] 保留必要的「重篩」字眼在放寬標準情境中，但不可作為整個模組名稱。
- [ ] 篩選條件可依二次篩選理由查詢。
- [x] 詳情頁時間線區分來源理由與執行工單。
