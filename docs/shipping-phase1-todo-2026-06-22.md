...
- [x] 確認二次重篩採「案件主檔 + 明細 + 執行工單」模型
- [x] 確認二次重篩與退貨單第一版先採 1 對 1 關聯
- [x] 確認二次重篩主檔必須直接關聯原始訂單、原始工單
- [x] 確認二次重篩分為 `strict_rescreen` / `relaxed_rescreen`
- [x] 確認二次重篩第一版必須從退貨單建立
- [x] 確認一張退貨單第一版只允許對應一張二次重篩案件
- [x] 確認二次重篩使用獨立案件編號
- [x] 確認二次重篩完成後需形成新庫存，且必須保留完整來源鏈
...
- [ ] 尚待補齊二次重篩完成後的新庫存建立、再次不良閉環與不良品歷史正式納管
...
- [x] 確認退貨後二次重篩需建立獨立案件資料表，並由工單作為執行載體
- [x] 確認二次重篩再次產生的不良需建立正式來源，不可只沿用一般工單不良備註
- [x] 確認二次重篩第一版與退貨單先採 1 對 1
- [x] 確認二次重篩主檔需直接保存原始訂單、原始工單
- [x] 確認二次重篩需區分 `strict_rescreen` / `relaxed_rescreen`
- [x] 確認二次重篩第一版必須從退貨單建立
- [x] 確認一張退貨單第一版只允許對應一張二次重篩案件
- [x] 確認二次重篩使用獨立案件編號
- [x] 確認二次重篩完成後需形成新庫存，且必須保留完整來源鏈
