                    ...
                    sections: [
                        {
                            title: '權限資訊',
                            fields: [
                                { name: 'name', label: '權限名稱', type: 'text', required: true, maxlength: 100, placeholder: '例如：manage_orders' },
                                { name: 'description', label: '描述', type: 'textarea', rows: 3, maxlength: 255, placeholder: '請輸入權限描述' }
                            ]
                        }
                    ]
                }
